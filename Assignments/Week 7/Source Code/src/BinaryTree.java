...
public class BinaryTree<E> {
    ...
    // These constants are passed to traverse() to specify the type of traversal.
    ...
    public int getSize() {
        ...
        // Create a Counter object to count the nodes Counter counter = new Counter();
        ...
        // After we finish the traverse, Counter.mCount is equal to the number of nodes visited, which // is the size of the tree.
